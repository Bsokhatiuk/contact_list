...
<div>
    ...
    <form:form method="POST" modelAttribute="newRecordForm" class="form-signin">
        ...
        <spring:bind path="surname">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="surname" class="form-control" placeholder="Surname" value="${record.surname}"></form:input>
        ...
        <spring:bind path="patronymic">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="patronymic" class="form-control" placeholder="Patronymic" value="${record.patronymic}"></form:input>
            ...
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input  type="tel" path="mobilePhone" class="form-control"  pattern="\([0-9]{3}\)[0-9]{3}[0-9]{2}[0-9]{2}" placeholder="(050)1213457"
                             title="Format is (XXX)xxxxxxx required" value="${record.mobilePhone}"></form:input>
        ...
        <spring:bind path="homePhone">
            <div class="form-group">
                <form:input type="text" path="homePhone" class="form-control" placeholder="Home Phone"
